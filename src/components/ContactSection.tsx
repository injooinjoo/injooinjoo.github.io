  ...
  return (
    <section id="contact" className="min-h-screen flex items-center bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <ScrollSection className="animate-slide-in-bottom">
          <h2 className="text-5xl md:text-6xl font-thin mb-8">
            Thank you.
          </h2>
        </ScrollSection>
        
        <ScrollSection delay={200} className="animate-slide-in-bottom">
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto leading-relaxed">
            함께 성장하는 미래를 기대합니다.
          </p>
        </ScrollSection>
        
        <ScrollSection delay={400} className="animate-scale-in">
        ...
        <ScrollSection delay={600} className="animate-fade-in">
