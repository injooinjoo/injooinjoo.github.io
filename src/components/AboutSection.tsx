...
const AboutSection = () => {
  return (
    <section id="about" className="min-h-screen py-20 flex items-center bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <ScrollSection direction="left" speed={0.5} className="space-y-8">
          ...
          <ScrollSection delay={300} direction="right" speed={0.5} className="animate-slide-in-right">
